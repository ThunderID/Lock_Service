<?php
	...
	$channel->queue_declare('notarispro.lock.delete', false, false, false, false);
	...
	$channel->basic_consume('notarispro.lock.delete', '', false, false, false, false, $callback);
